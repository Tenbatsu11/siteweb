    ...
    <main class="fade-in">
        <div class="container">
            <a href="https://kumiai.sukai.moe/fr/">
                <img class="img-fluid" src="/siteweb/assets/images/logo-kumiai.png" alt="Kumiai">
            </a>
        </div>
        <div class="container" style="text-align: center; margin-top: 50px; margin-bottom: 50px; max-width: 800px; margin-left: auto; margin-right: auto;">
            ...
            <p>Enfin, n'oubliez pas de consulter notre section "Bien Commencer", 
                ...
                <h3>Bonne chance dans votre apprentissage du japonais avec Kumiai !</h3>
